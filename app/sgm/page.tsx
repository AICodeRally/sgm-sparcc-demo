  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-3 gap-6 mb-12">
          {/* Governance Matrix */}
          <Link href="/sgm/governance-matrix">
